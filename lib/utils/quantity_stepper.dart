...
class _Stepper2State extends State<StepperTouch> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return FittedBox(
      child: Container(
        width: widget.direction == Axis.horizontal ? 280.0 : 80.0,
        height: widget.direction == Axis.horizontal ? 80.0 : 120.0,
        child: Material(
                    ...
                    child: Center(
                      child: AnimatedSwitcher(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: Color(0xFF6D72FF), fontSize: 56.0),
                        ),
                      ),
                    ),
                  ),
